...
//   // const url = "https://66c58796134eb8f434949496.mockapi.io/userLogin";
...
export default function SignInModal() {
  ...
  const onSubmit = async (data) => {
    try {
      const response = await axios.get('https://66c58796134eb8f434949496.mockapi.io/userLogin');
      ...
      if (matchedUser) {
        ...
        if (matchedUser.role === "Admin") {
          ...
          navigate('/user/home'); // Điều hướng đến trang mặc định nếu role không phải Admin hay Employee
        }
      } else {
        // Đăng nhập thất bại
        toast.error(t("signin.invalid_credentials"));
      }
    } catch (error) {
      toast.error(t("signin.error_occurred"));
    }
  };
