      ...
      <div className="mt-8 space-y-4">
        ...
        <div className="mt-8">
          <p className="font-semibold text-gray-700">
            Lưu ý: Quá trình xác nhận thanh toán COD và chuyển khoản ngân hàng có thể mất vài phút. Vui lòng theo dõi tình trạng đơn hàng trong phần quản lý đơn hàng của bạn.
          </p>
        </div>
