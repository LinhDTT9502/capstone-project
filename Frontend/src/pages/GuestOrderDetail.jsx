...
import RefundRequestsPopup from "../components/Order/RefundRequestsPopup";
           ...
           <div className="mb-16 bg-orange-100">
             ...
             >
               {ORDER_STEPS.map((status, index) => {
                 ...
                 const isRedStep = orderStatusId === 6 && index >= currentIndex;
           ...
           <div className="col-span-1 flex flex-col gap-4">
             ...
             {orderStatus === "Đã hủy" &&
               ...
               orderDetail.refundRequests.$values?.length == 0 && (
                 <RefundRequestFormm orderDetail={orderDetail} />
               )}
           </div>
         </div>
       </div>
