...
export default function GuestRentalOrder() {
      ...
      <div className="rounded-lg overflow-x-auto w-full">
        <div className="flex justify-start p-4 bg-gray-50 border-b space-x-2 whitespace-nowrap">
          {[
            ...
            <button
              key={status}
              className={`px-4 py-2 rounded-full text-sm font-medium transition-colors duration-150 ease-in-out ${selectedStatus === status
